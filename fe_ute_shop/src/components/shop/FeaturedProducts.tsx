    ...
    useEffect(() => {
        ...
        (async () => {
            ...
            try {
                ...
                switch (tab) {
                    case "new":
                        products = await productsApi.getLatestProducts(8);
                        break;
                    case "best":
                        products = await productsApi.getBestSellingProducts(8);
                        break;
                    case "deals":
                        products = await productsApi.getHighestDiscountProducts(8);
                        break;
                    default:
                        products = await productsApi.getLatestProducts(8);
                }
