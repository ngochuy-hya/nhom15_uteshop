...
export default function Features3({
  parentClass = "flat-spacing-4",
  itemClass = "tf-icon-box style-lg wow fadeInLeft",
}) {
  return (
    <div className={parentClass}>
      <div className="container">
        ...
        >
          ...
          <SwiperSlide className="swiper-slide">
            <div className={itemClass} data-wow-delay="0.1s">
              <svg
                width={64}
                height={64}
                viewBox="0 0 64 64"
          ...
          <SwiperSlide className="swiper-slide">
            <div className={itemClass} data-wow-delay="0.2s">
              <svg
                width={64}
                height={64}
                viewBox="0 0 64 64"
              ...
              <div className="content">
                <div className="title text-uppercase">Support Online</div>
