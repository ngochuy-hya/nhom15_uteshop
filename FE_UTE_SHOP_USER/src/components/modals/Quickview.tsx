...
export default function Quickview() {
  ...
  // Ensure quickViewItem is defined
  if (!quickViewItem) {
    return <div>Loading...</div>; // Show a loading state or message
  }

  // Get quantity safely
  const currentQuantity = isAddedToCartProducts(quickViewItem.id)
              ...
              <SwiperSlide className="swiper-slide" data-color="orange">
                <div className="item">
                  <img
                    className="lazyload"
                    alt=""
                    src={quickViewItem.imgHover || quickViewItem.imgSrc}
                    width={513}
                    height={729}
                  />
                </div>
            ...
            <div className="tf-product-info-inner">
              <div className="tf-product-heading">
                <h6 className="product-name">
                  <Link to={`/product-detail/${quickViewItem.id}`} className="link">
                    {quickViewItem.title}
                  </Link>
                </h6>
                ...
                <p className="text">
                  A beautifully handcrafted item made with care and premium materials, showcasing unique artistry and thoughtful details.
                  Ideal for adding warmth and character to any space, while celebrating the charm of handmade craftsmanship.
                </p>
              </div>
              ...
              <div className="tf-product-total-quantity">
                ...
                <a href="#" className="tf-btn w-100 animate-btn paypal btn-primary">
                  Buy It Now
                </a>
              ...
              <Link to={`/product-detail/${quickViewItem.id}`} className="view-details link">
