...
// đảm bảo ở cấp global/layout bạn đã có import css của Swiper:
// import "swiper/css";
...
export default function Products() {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        // Most Popular = sản phẩm trending hoặc sort theo view_count
        const response = await productAPI.getProducts({ limit: 12, is_trending: 'true', sort_by: 'view_count', sort_order: 'DESC' });
